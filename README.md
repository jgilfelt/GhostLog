...
Include the integration libary ([JAR](https://raw.github.com/jgilfelt/GhostLog/master/Integration/ghostlog-integration-1.0.0.jar)) in your project:
...
This will enable your app to receive messages from the Ghost Log app to start and stop a service inside your app which will monitor and broadcast all log output generated by your application processes back to Ghost Log for display.
